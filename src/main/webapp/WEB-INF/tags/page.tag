...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/font-awesome/4.7.0/css/font-awesome.min.css"/>
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/jquery-ui.custom.min.css" />
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/chosen.min.css" />
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/daterangepicker.min.css" />
	<link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/ui.jqgrid.min.css" />
	<link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/bootstrap-datepicker3.min.css"/>
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/bootstrap-timepicker.min.css" />
    ...
    <!-- ace styles -->
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/ace.min.css"
          class="ace-main-stylesheet" id="main-ace-style"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/ace-part2.min.css"
    ...
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="${contextPath}/static-resource/ace/assets/css/ace-ie.min.css"/>
    <![endif]-->
    <link rel="stylesheet" href="${contextPath}/static-resource/common/css/layer.css"/>
    <link rel="stylesheet" href="${contextPath}/static-resource/common/css/kalendae.css"/>
    <link rel="stylesheet" href="${contextPath}/static-resource/common/css/lesson.css"/>
    ...
    <!--[if lte IE 8]>
    <script src="${contextPath}/static-resource/ace/assets/js/html5shiv.min.js"></script>
    <script src="${contextPath}/static-resource/ace/assets/js/respond.min.js"></script>
    <![endif]-->
    <!--[if !IE]> -->
    ...
    <!--[if IE]>
    <script src="${contextPath}/static-resource/ace/assets/js/jquery-1.11.3.min.js"></script>
    <![endif]-->
				...
				<c:if test="${userOfLogin.userType=='admin'}">
	                <div class="sidebar-shortcuts" id="sidebar-shortcuts">
	                    <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
	                        <a class="btn btn-success" href="trip/list.do">
	                            <i class="ace-icon fa fa-list"></i>
	                        </a>
	                        <a class="btn btn-info" href="trip/online.do">
	                            <i class="ace-icon fa fa-calendar-check-o"></i>
	                        </a>
	
	                        <a class="btn btn-warning" href="support/room/merge/cities.do">
	                            <i class="ace-icon fa fa-stack-overflow"></i>
	                        </a>
	
	                        <a class="btn btn-danger" href="support/invoice/search.do">
...
<%--		                            <span class="menu-text"><spring:message code="welcome.hotel.offer" var="offer"/>${offer}</span>--%>
		                            <b class="arrow fa fa-angle-right"></b>
		                        </a>
		                        <b class="arrow"></b>
		                    </li>
...
<script type="text/javascript">
    if ('ontouchstart'
        in document.documentElement) document.write("<script src='${contextPath}/static-resource/ace/assets/js/jquery.mobile.custom.min.js'>"
        + "<"
        + "/script>");
</script>
<script src="${contextPath}/static-resource/ace/assets/js/bootstrap.min.js"></script>
...
<script src="${contextPath}/static-resource/ace/assets/js/chosen.jquery.min.js"></script>
<script src="${contextPath}/static-resource/ace/assets/js/jquery.dataTables.min.js"></script>
<script src="${contextPath}/static-resource/ace/assets/js/jquery.dataTables.bootstrap.min.js"></script>
<script src="${contextPath}/static-resource/ace/assets/js/bootstrap-datepicker.min.js"></script>
<script src="${contextPath}/static-resource/ace/assets/js/moment.min.js"></script>

<!-- ace scripts -->
<script src="${contextPath}/static-resource/ace/assets/js/spinbox.min.js"></script>
...
<script src="${contextPath}/static-resource/ace/assets/js/jquery.validate.min.js"></script>

<!-- support for act beetbox -->
<script src="${contextPath}/static-resource/ace/assets/js/bootbox.js"></script>

<script src="${contextPath}/static-resource/common/js/layer.js"></script>
<script src="${contextPath}/static-resource/common/js/localos.js"></script>
