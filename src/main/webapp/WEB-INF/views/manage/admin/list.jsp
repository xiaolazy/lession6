                        ...
                        <div class="col-xs-12">
                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-480"><spring:message code="user.seePolicy"/></th>
                                ...
                                <c:forEach items="${admins}" var="user">
                                    <tr id="tr-${user.userId}">
                                        ...
                                        <td class="hidden-480">
                                        	<c:choose>
                                        	<c:when test="${user.seePolicy.value==1}"><spring:message code="seePolicy.1"/></c:when>
                                        	<c:when test="${user.seePolicy.value==100}"><spring:message code="seePolicy.100"/></c:when>
                                        	<c:otherwise>
                                        		<c:forEach items="${user.organizes}" var="organize">
                                        			${organize.name}&nbsp;
                                        		</c:forEach>
                                        	</c:otherwise>
                                        	</c:choose>
                                                ...
                                                <div class="profile-user-info profile-user-info-striped">
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <span><c:out value="${user.nameEn}"/></span>
                                                        </div>
                                                    </div>
                                                    <div class="profile-info-row">
                                                        <div class="profile-info-row">
                                                            <div class="profile-info-name"><spring:message code="tel"/>/<spring:message
                                                                    code="fax"/>/<spring:message code="mobile"/></div>
                                                            <div class="profile-info-value">
