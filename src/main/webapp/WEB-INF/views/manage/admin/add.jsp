    ...
    <jsp:attribute name="script">
        ...
        <script type="application/javascript">
            ...
            jQuery(function ($) {
                ...
                $('#seePolicy').on('change', function (e) {
                    e.preventDefault();
                    seePolicyReady();
                });
                seePolicyReady();
            ...
            function seePolicyReady() {
                if($('#seePolicy').val() == 10){
                    ...
                    $("input[name='organizes']").each(function () {
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="manage/user/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="seePolicy">
                                        <spring:message code="user.seePolicy"/>
                                    </label>
                                    <div class="col-sm-3">
                                        <select class="form-control chosen-select" id="seePolicy" name="seePolicy" >
                                            <option value="1"   ${admin.seePolicy.value==1 ? "selected": ""}><spring:message code="seePolicy.1" /></option>
                                            <option value="10"  ${admin.seePolicy.value==10 ? "selected": ""}><spring:message code="seePolicy.10" /></option>
                                            <option value="100" ${admin.seePolicy.value==100 ? "selected": ""}><spring:message code="seePolicy.100" /></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group show-hidden">
                                    <label class="col-sm-3 control-label no-padding-right show-hidden"> <spring:message code="user.organizes"/> </label>
									<div class="col-sm-9 show-hidden" style="margin-top: 7px">
                                        <c:forEach items="${organizes}" var="organize">
                                            <label>
                                                <input ${admin.organizeMap.get(organize.id)?"checked":""} id="organizes" name="organizes" class="ace  ace-checkbox-2" type="checkbox"
                                                       value="${organize.id}"/>
                                                <span class="lbl">${organize.name}</span>
                                            </label>
                                            <br>
                                        </c:forEach>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> <spring:message code="user.widgets"/> </label>
									<div class="col-sm-9" style="margin-top: 7px">
                                        <c:forEach items="${widgets}" var="widget">
                                            <label>
                                                <input ${widgetMap.get(widget.id)?"checked":""} id="widgets" name="widgets" class="ace ace-checkbox-2" type="checkbox"
                                                       value="${widget.id}"/>
                                                <span class="lbl">${widget.name}</span>
                                            </label>
                                            <br>
                                        </c:forEach>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-sm-9">
                                        <c:forEach items="${groups}" var="group">
                                            <div class="checkbox">
                                                <label>
                                                    <input value="${group.id}" name="groups" class="ace ace-checkbox-2" type="checkbox" ${admin.groupMap[group.id] ? "checked" : ""}>
