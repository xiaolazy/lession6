...
<form class="form-horizontal" role="form"  id="form-add">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="name" name="name" value="${data.name}" placeholder="请输入学科名称" class="col-xs-10 col-sm-5" />
        </div>
    </div>
    <div class="col-sm-9">
...
<script type="text/javascript">
    ...
    function submit() {
        ...
        operate.add(dataFormJson,'/subject/save_edit.do?id='+id,"学科编辑")
    }
