...
<sec:authorize ifAnyGranted="OPT_TRIP_VIEW"><c:set var="opt_trip_view" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_TRIP_EDIT"><c:set var="opt_trip_edit" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_TRIP_STATUS"><c:set var="opt_trip_status" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_TRIP_QUOTATION"><c:set var="opt_trip_quotation" value="True"/></sec:authorize>

<sec:authorize ifAnyGranted="OPT_SUP_INVOICE_VIEW"><c:set var="opt_invoice" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_ROOM_VIEW"><c:set var="opt_room" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_COACH_VIEW"><c:set var="opt_coach" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_MEAL_VIEW"><c:set var="opt_meal" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_GUIDE_VIEW"><c:set var="opt_guide" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_TICKET_VIEW"><c:set var="opt_ticket" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_SUP_TRIP_FEE_VIEW"><c:set var="opt_fee" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_TRIP_VISITOR_VIEW"><c:set var="opt_visitor" value="True"/></sec:authorize>
<sec:authorize ifAnyGranted="OPT_FIN_PAYNOTICE_VIEW"><c:set var="opt_payNotice" value="True"/></sec:authorize>
